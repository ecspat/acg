...
This is an implementation of field-based call graph construction for JavaScript as described in
...
This code is licensed under the [Eclipse Public License (v1.0)](http://www.eclipse.org/legal/epl-v10.html), a copy of which is included in this repository in file `LICENSE.txt`.